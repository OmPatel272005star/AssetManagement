    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
            ...
            <Divider />
            <List>
                <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Asset")}}>
                <ListItemButton
                    sx={{
                    minHeight: 48,
                    justifyContent: open ? 'initial' : 'center',
                ...
                >
                    ...
                    <ListItemText primary="Asset" sx={{ opacity: open ? 1 : 0 }} />
                </ListItemButton>
                </ListItem>
            </List>
            <Divider />
        ...
        <Divider />
            <List>
                <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Allocation")}}>
                <ListItemButton
                    sx={{
                    minHeight: 48,
                    justifyContent: open ? 'initial' : 'center',
